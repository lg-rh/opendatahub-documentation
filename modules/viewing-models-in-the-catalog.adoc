...
[NOTE]
====
On the `s390x` architecture, only the `granite-3.3-8b-instruct` model is supported. The  `granite-3.3-8b-instruct` model card is available from the *All models* category in the menu bar of the model catalog.
====
